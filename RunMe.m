...
% ==============================================================================
%  备注：
%  1. 结果精度不高，且没有考虑运动学方程约束，直接将其用于泊车问题的可能性不大，往往需要衔接优化方案.
...
xyt_graph_search_.num_nodes_t = 81;
xyt_graph_search_.resolution_t = xyt_graph_search_.max_t / (xyt_graph_search_.num_nodes_t - 1);
xyt_graph_search_.resolution_x = xyt_graph_search_.resolution_t * vehicle_kinematics_.vehicle_v_max / (4 * 1.414);
...
xyt_graph_search_.multiplier_H_for_A_star = 5.0;
xyt_graph_search_.weight_for_time = 2.0;
xyt_graph_search_.max_iter = 2000;
% % 导入既定算例以及静止障碍物分布情况
